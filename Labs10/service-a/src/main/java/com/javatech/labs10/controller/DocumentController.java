package com.javatech.labs10.controller;

import com.javatech.labs10.annotations.JWTTokenRequired;
import com.javatech.labs10.dtos.*;
import com.javatech.labs10.exceptions.*;
import com.javatech.labs10.pemissions.Role;
import com.javatech.labs10.service.DocumentService;
import com.javatech.labs10.utils.ResponseEntityPayload;
...
public class DocumentController {
    ...
    public Response getDocument( @PathParam("documentId") Long documentId) throws DocumentNotFoundException {
    ...
    public Response addAuthorToDocument(@Context SecurityContext securityContext,
                                        ...
                                        DocumentAddAuthorDTO author) throws DocumentAuthorNotFoundException, DocumentNotFoundException, DocumentInvalidOwnershipException, DocumentAuthorAlreadyExistsException {
    ...
    @JWTTokenRequired(Permissions = {Role.AUTHOR, Role.AUTHOR, Role.REVIEWER})
    @Produces(MediaType.APPLICATION_JSON)
    public Response removeDocument(@Context SecurityContext securityContext, @PathParam("docId") Long documentId) throws DocumentNotFoundException, DocumentInvalidOwnershipException {
    ...
    public Response removeAuthorFromDocument(@Context SecurityContext securityContext,
                                             @PathParam("docId") Long documentId,
                                             @PathParam("authorId") Long authorId) throws DocumentAuthorNotFoundException, DocumentNotFoundException, DocumentInvalidOwnershipException {
    ...
    public Response addReferenceToDocument(@Context SecurityContext securityContext,
                                           ...
                                           DocumentAddReferenceDTO reference) throws DocumentReferenceNotFoundException, DocumentNotFoundException, DocumentInvalidOwnershipException, DocumentCircularReferenceException, DocumentReferenceAlreadyExistsException {
    ...
    public Response deleteReferenceFromDocument(@Context SecurityContext securityContext,
                                                @PathParam("documentId") long documentId,
                                                @PathParam("referenceId") long referenceId) throws DocumentReferenceNotFoundException, DocumentNotFoundException, DocumentInvalidOwnershipException {
    ...
    public Response getReferencesFromDocument(@Context SecurityContext securityContext,
                                              @PathParam("documentId") long documentId) throws DocumentNotFoundException {
