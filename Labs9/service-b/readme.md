...
This will create an executable jar file **labs9-microbundle.jar** within the _target_ maven folder. This can be started by executing the following command
    java -jar target/labs9-microbundle.jar --port 8180
